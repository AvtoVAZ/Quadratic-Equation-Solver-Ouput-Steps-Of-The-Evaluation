...
print("g = ",c)
print("===================================================")
#Calculating the value of the Discriminant by seperating the equation into seperate parts
#It is seperated so the output can print each step of the calculating process
discriminant1 = ((b)**2)
discriminant2 = ((a) * (c))
...
if discriminant4 < 0:
    #If the value of the Discriminant is smaller that 0 (Δ < 0) the process of calculating the equation cannot be continued
...
#If the value of Δ is greater or equal to 0 (Δ ≥ 0) the process of calculating the equation can be continued
    ...
    print("===================================================")
    #If the Discriminant is greater than 0 the evaluation of x1,x2 will be proceded
    if discriminant4 > 0:
        #Seperating the equation of x1 into different parts
        ...
        print("===================================================")
        #Seperating the equation of x2 into different parts
    ...
    if discriminant4 == 0:
        #Seperating the equation of x into different parts
        #The value of x is also being calculatd
        x_arithmitis1 = (-(b))
        x_paronomastis1 = (2 * (a))
